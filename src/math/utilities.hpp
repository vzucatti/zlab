...
// This overload will now be correctly selected ONLY when the exponent is an
// integer.
//
// ALGORITHM: Exponentiation by Squaring
// This method calculates a^n (for integer n) in O(log n) time. It avoids n
// linear multiplications by halving the exponent (m /= 2) and checking if m is
// odd (m % 2 == 1).
